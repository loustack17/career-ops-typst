...
12. Write to `output/{YYYY-MM-DD}/cv-{candidate}-{company}-{YYYY-MM-DD}.tex`
13. Run: `node generate-latex.mjs output/{YYYY-MM-DD}/cv-{candidate}-{company}-{YYYY-MM-DD}.tex output/{YYYY-MM-DD}/cv-{candidate}-{company}-{YYYY-MM-DD}.pdf`
