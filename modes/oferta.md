...
Classify the offer into one of the 6 archetypes (see `_shared.md`). If hybrid, indicate the 2 closest ones. This determines:
...
3. **Plan "if I get downleveled"**: accept if comp is fair, negotiate a 6-month review, clear promotion criteria
...
- Report: relative link to .md report (e.g.: `[001](reports/001-company-2026-01-01.md)`)
